...
import { BarChart2, Lock, User, Loader2 } from 'lucide-react';
        ...
        <div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-[#0f172a]">
            ...
            <div className="relative z-10 w-full max-w-md p-8 rounded-2xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] backdrop-blur-xl bg-slate-900/60">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 tracking-tight">
                        Analytics Portal
                    </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                type="text"
                                className="w-full pl-10 pr-4 py-3 bg-slate-950/50 border border-slate-700/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50 text-white placeholder-slate-600 transition-all duration-200 hover:bg-slate-950/70 hover:border-slate-600 disabled:opacity-50 disabled:cursor-not-allowed"
